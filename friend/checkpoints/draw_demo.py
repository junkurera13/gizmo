"""Render the drawing-demo reply in Gizmo's production Umbriel voice.

Run from the repository root after placing GEMINI_API_KEY in the ignored .env:
python friend/checkpoints/draw_demo.py
"""
...
OUTPUT = ROOT / "friend" / "gizmo_friend" / "static" / "demo-draw-gizmo.wav"
REPLY = (
