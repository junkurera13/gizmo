    ...
    def test_cloud_preview_is_public_shell_with_open_session(self):
        ...
        with tempfile.TemporaryDirectory() as directory, patch.dict("os.environ", environment):
            ...
            with TestClient(app_factory(root)) as client:
                ...
                self.assertEqual(client.get("/static/demo-antarctica-followup-kid.mp3").status_code, 200)
                self.assertEqual(client.get("/static/demo-antarctica-followup-gizmo.wav").status_code, 200)
                self.assertEqual(client.get("/static/demo-antarctica-followup.mp4").status_code, 200)
                ...
                self.assertEqual(client.get("/static/demo-math-fraction-camera.mp4").status_code, 200)
                self.assertEqual(client.get("/static/demo-math-fraction-gizmo.wav").status_code, 200)
