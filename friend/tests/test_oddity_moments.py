...
class MomentCatalogTests(unittest.TestCase):
    ...
    def test_inline_cinema_cover_fills_above_the_caption_band(self):
        ...
        self.assertIn("height:20%;z-index:2;background:#000", css)
        self.assertNotIn("background:#05111f", css)
    ...
    def test_inline_cinema_replaces_demo_rail_with_composer(self):
        ...
        self.assertIn("talk: $('talk')", script)
        self.assertNotIn("cinema-talk", script)
        self.assertNotIn("cinema-progress", script)
        self.assertNotIn("cinema-progress", controller)
