...
- motion: one short phrase of visible action belonging to this beat, such as the rocket lifting off on a plume of flame, a whale swimming, or ash drifting. When the kid requests an action, show that action instead of substituting background smoke or mist. Quiet motion is appropriate for a quiet beat. No cuts, no people, no unrelated objects.
