...
with the clock and a battery icon, push-to-talk voice memo into
...
the Outfit clock atlas as an 8-bit mask, the chime
...
minimum, 2875 ms chime, 0.045 status top, atlas cells, clock
...
include/gizmo/assets.h     embedded bundle access: boot slot / home base decode, clock atlas, chime
include/gizmo/assets_generated.h   GENERATED by tools/embed_assets.py from manifest.json
include/gizmo/screens.h    HUD (clock + battery) and the memo overlays
