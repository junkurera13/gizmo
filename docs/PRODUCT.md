...
**Status:** Talk and Think are live. See is live as camera frames on the current turn; the glass is not the viewfinder-plus-head yet. Show is next. Make follows Show. Play waits until Show is real. Show, Make, and Play are not wired to the agent yet; the prompt says so.
